...
if (!ved) {
    ...
    fetch("https://youtube.googleapis.com/youtube/v3/playlistItems?part=contentDetails%20%2Csnippet&playlistId=PL8CyQ6qMY4V7Udno3bT8Go7WRu1xVEyS3&key=AIzaSyCoQ5_IY3cZs8bu3_pwXPw6xnfatyZtfAU")
        .then((res) => res.json())
        .then(data => {
